...
use Demo\TestBundle\Entity\Pays;
...
class PaysController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pays = $em->getRepository('DemoTestBundle:Pays')->findAll();
    ...
    {
        $pay = new Pays();
        $form = $this->createForm('Demo\TestBundle\Form\PaysType', $pay);
    ...
    {
        $deleteForm = $this->createDeleteForm($pay);
        $editForm = $this->createForm('Demo\TestBundle\Form\PaysType', $pay);
